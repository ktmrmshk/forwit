...
class UserProfile(models.Model):
    ...
    job = models.CharField(max_length=64, default='Current Affiliation', blank=True)
    title = models.CharField(max_length=64, default='Current Title', blank=True)
    school1 = models.CharField(max_length=64, default='Japan University', blank=True)
    school_project = models.CharField(max_length=64, default='Lab', blank=True)
    shoool_dept = models.CharField(max_length=64, default='Computer Science', blank=True)
    qualification = models.CharField(max_length=64, default='Ph.D of Computer Science', blank=True)
    interesting1 = models.CharField(max_length=64, default='Your Research Filed', blank=True)
    interesting2 = models.CharField(max_length=64, default='', blank=True)
    interesting3 = models.CharField(max_length=64, default='', blank=True)
